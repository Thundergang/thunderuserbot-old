...
@thunderbot.on(admin_cmd(pattern=r"(set|get|del) var (.*)", outgoing=True))
...
@thunderbot.on(admin_cmd(pattern="usage"))
@thunderbot.on(sudo_cmd(pattern="usage", allow_sudo=True))
...
@thunderbot.on(admin_cmd(pattern="info heroku"))
@thunderbot.on(sudo_cmd(pattern="info heroku", allow_sudo=True))
...
@thunderbot.on(admin_cmd(outgoing=True, pattern=r"logs"))
@thunderbot.on(sudo_cmd(allow_sudo=True, pattern=r"logs"))
async def _(givelogs):
    ...
    with open("logs-thunderbot.txt", "w") as log:
    ...
    return os.remove("logs-thunderbot.txt")
