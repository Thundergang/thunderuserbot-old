...
GIT_REPO_NAME = "thunderuserbot"
UPSTREAM_REPO_URL = "https://github.com/Thundergang/thunderuserbot"
...
async def upstream(ups):
    ...
    if ac_br != "master":
        await ups.edit(
            ...
            "Please checkout the official branch of ThunderUserbot`"
        )
        repo.__del__()
        return
    ...
    if Var.HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            ...
            return
        await ups.edit(
            "`New update's build is in progress, please wait 7-8 minutes or until you gets a started message.`"
        )
        ups_rem.fetch(ac_br)
