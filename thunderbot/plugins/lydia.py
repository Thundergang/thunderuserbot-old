...
@thunderbot.on(admin_cmd(pattern="repcf", outgoing=True))
@thunderbot.on(sudo_cmd(pattern="repcf", allow_sudo=True))
...
@thunderbot.on(admin_cmd(pattern="addcf", outgoing=True))
@thunderbot.on(sudo_cmd(pattern="addcf", allow_sudo=True))
...
@thunderbot.on(admin_cmd(pattern="remcf", outgoing=True))
@thunderbot.on(sudo_cmd(pattern="remcf", allow_sudo=True))
